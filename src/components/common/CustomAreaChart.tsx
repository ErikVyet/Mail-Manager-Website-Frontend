...
function CustomeAreaChart({ width, height, data, xDataKey, yDataKey, xFontSize, yFontSize, color = "blue", stroke = true, loading = false, animationDuration }: CustomeLineChartProps) {
    ...
    return (
        loading ? (
            ...
            <ResponsiveContainer width={width} height={height}>
                <AreaChart data={data} accessibilityLayer={false} responsive>
                    ...
                    <Area fill={"url(#areaColor)"} dataKey={yDataKey} animationDuration={animationDuration}/>
                </AreaChart>
            </ResponsiveContainer>
        )
    );
