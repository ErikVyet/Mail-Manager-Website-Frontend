...
function ApiKeyTableHeader() {
    ...
    return (
        <Stack className="px-3 py-0.5 items-center" direction={"row"}>
            ...
            <Typography className={`flex-[45%] grow-0 shrink-0 text-sm! font-sans! font-semibold! ${theme === Theme.Light ? TEXT_LIGHT : TEXT_DARK} select-none`}>Key</Typography>
            ...
            <Typography className={`flex-[10%] grow-0 shrink-0 text-sm! font-sans! font-semibold! ${theme === Theme.Light ? TEXT_LIGHT : TEXT_DARK} select-none`}>Usage</Typography>
