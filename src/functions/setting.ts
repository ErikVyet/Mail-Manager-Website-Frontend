...
export async function fetchSignature(token: string): Promise<ResponseEntity<string>> {
...
export async function regenerateSignature(token: string): Promise<ResponseEntity<string>> {
